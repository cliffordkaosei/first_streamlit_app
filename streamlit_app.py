...
streamlit.text('🥣 Olmega 3 & Blueberry Oatmeal')
...
# Put selected fruit list into dataframe
...
try:
  ...
  if not fruit_choice:
    ...
    streamlit.dataframe(back_from_function)  # puts the data into a new dataframe
except URLError as e:
  streamlit.error()


#import snowflake connector
streamlit.header("View our fruit list - add your favortites!")
